...
define("REMOTE_REPOSITORY", "git@github.com:exotik850/901Coding.git"); // The SSH URL to your repository
define("DIR", "/var/www/html/901Coding/");                          // The path to your repostiroy; this must begin with a forward slash (/)
